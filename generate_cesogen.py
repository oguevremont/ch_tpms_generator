...
def run(params):
    ...
    if running_on_mac:
        ...
        command_line_str = f"./executables_and_scripts/cesogen -s {finesse} box scale 0.5,0.5,0.5 TYPE_FILLING scale SCALING_X,SCALING_Y,SCALING_Z THICKNESS intersection -o generated.stl"
